...
function loadTables(startPage, pageSize) {
    ...
    $.ajax({
        type: "GET",
        url: "/SysManage/User/GetUserByDepartment?startPage=" + startPage + "&pageSize=" + pageSize + "&departmentId=" + selectedId + "&_t=" + new Date().getTime(),
        success: function (data) {
...
function edit(id) {
    $.ajax({
        type: "Get",
        url: "/SysManage/User/Get?id=" + id + "&_t=" + new Date().getTime(),
        success: function (data) {
            $("#Id").val(data.id);
