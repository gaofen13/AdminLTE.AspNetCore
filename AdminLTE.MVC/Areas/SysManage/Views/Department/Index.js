...
function initTree() {
    ...
    $.ajax({
        type: "Get",
        url: "/SysManage/Department/GetTreeData?_t=" + new Date().getTime(),    //获取数据的ajax请求地址
...
function loadTables(startPage, pageSize) {
    ...
    $.ajax({
        type: "GET",
        url: "/SysManage/Department/GetChildrenByParent?startPage=" + startPage + "&pageSize=" + pageSize + "&parentId=" + selectedId + "&_t=" + new Date().getTime(),
        success: function (data) {
...
function edit(id) {
    $.ajax({
        type: "Get",
        url: "/SysManage/Department/Get?id=" + id + "&_t=" + new Date().getTime(),
        success: function (data) {
            $("#Id").val(data.id);
...
function deleteMulti() {
    ...
    layer.confirm("您确认删除选定的记录吗？", {
        ...
        $.ajax({
            type: "Post",
            url: "/SysManage/Department/DeleteMuti",
            data: sendData,
            success: function (data) {
                if (data.result == "Success") {
                    initTree();
...
function deleteSingle(id) {
    layer.confirm("您确认删除选定的记录吗？", {
        ...
        $.ajax({
            type: "POST",
            url: "/SysManage/Department/Delete",
            data: { "id": id },
            success: function (data) {
                if (data.result == "Success") {
                    initTree();
