...
$(function () {
    ...
    $('.btn-icon').click(function () {
        var iconurl = $(this).find('span').attr('class');
        $('#Icon').val(iconurl);
    });
...
function loadTables(startPage, pageSize) {
    ...
    $.ajax({
        type: "GET",
        url: "/SysManage/Menu/GetMenusByParent?parentId=" + selectedMenuId + "&startPage=" + startPage + "&pageSize=" + pageSize + "&_t=" + new Date().getTime(),
        success: function (data) {
...
function edit(id) {
    $.ajax({
        type: "Get",
        url: "/SysManage/Menu/Get?id=" + id + "&_t=" + new Date(),
        success: function (data) {
            $("#Id").val(data.id);
