...
function initTree() {
    ...
    $.ajax({
        type: "Get",
        url: "/SysManage/Menu/GetMenuTreeData?_t=" + new Date().getTime(),    //获取数据的ajax请求地址
...
function loadTables(startPage, pageSize) {
    ...
    $.ajax({
        type: "GET",
        url: "/SysManage/Role/GetAllPageList?startPage=" + startPage + "&pageSize=" + pageSize + "&_t=" + new Date().getTime(),
        success: function (data) {
...
function edit(id) {
    $.ajax({
        type: "Get",
        url: "/SysManage/Role/Get?id=" + id + "&_t=" + new Date().getTime(),
        success: function (data) {
            $("#Id").val(data.id);
            $("#Name").val(data.name);
            $("#Code").val(data.code);
...
function savePermission() {
    ...
    $.ajax({
        type: "POST",
        url: "/SysManage/Role/SavePermission",
...
function loadPermissionByRole(selectedRole) {
    $.ajax({
        type: "Get",
        url: "/SysManage/Role/GetMenusByRole?roleId=" + selectedRole + "&_t=" + new Date().getTime(),
        success: function (data) {
